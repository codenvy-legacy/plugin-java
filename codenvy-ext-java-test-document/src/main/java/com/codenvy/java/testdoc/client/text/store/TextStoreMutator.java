...
public interface TextStoreMutator {
     ...
     *
     * @param line
     *         the line containing the begin position for the delete
     * @param column
     *         the column (inclusive) where the delete will begin
     * @param deleteCount
     ...
     *
     * @param canReplaceSelection
     *         whether the mutator is allowed to replace the
