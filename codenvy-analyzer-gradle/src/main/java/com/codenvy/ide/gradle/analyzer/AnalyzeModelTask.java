...
/**
 * Analysis task. This task run Gradle tooling api, register custom plugin and request {@link com.codenvy.ide.gradle.analyzer.model
 * .TransportableJSON} which builds via {@link com.codenvy.ide.gradle.analyzer.GradleModelBuilder}.
 *
...
public class AnalyzeModelTask implements Callable<TransportableJSON> {
    ...
    /**
     * Get {@link com.codenvy.ide.gradle.analyzer.model.TransportableJSON} model based on Gradle project from Gradle tooling api.
     *
     ...
     * @param request
     *         type of model requested. {@link com.codenvy.ide.gradle.analyzer.model.TransportableJSONProjectDefinition} model only
     *         supports at this moment
     * @return {@link com.codenvy.ide.gradle.analyzer.model.TransportableJSON} object contains json string which represent built model
     */
