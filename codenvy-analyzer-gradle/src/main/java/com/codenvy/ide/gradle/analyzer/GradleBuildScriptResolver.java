...
public class GradleBuildScriptResolver {
    ...
    /**
     * Get instance of {@link com.codenvy.ide.gradle.analyzer.GradleBuildScriptResolver} and if it first calling of this method init.gradle
     * script will be created and stored in memory to fast accessing.
     *
     * @return instance of {@link com.codenvy.ide.gradle.analyzer.GradleBuildScriptResolver}
     */
