...
public class BecomeWorkingCopyOperation extends JavaModelOperation {
     ...
     */
    public BecomeWorkingCopyOperation(CompilationUnit workingCopy, IProblemRequestor problemRequestor, JavaModelManager manager) {
        super(new IJavaElement[]{workingCopy}, manager);
    ...
    protected void executeOperation() throws JavaModelException {
        ...
        manager
                .getPerWorkingCopyInfo(workingCopy, true/*create if needed*/, true/*record usage*/, this.problemRequestor);
