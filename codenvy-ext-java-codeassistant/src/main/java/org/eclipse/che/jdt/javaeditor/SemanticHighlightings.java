...
import org.eclipse.che.jdt.internal.corext.dom.ASTNodes;
import org.eclipse.che.jdt.internal.corext.dom.Bindings;
        ...
        public boolean consumes(SemanticToken token) {
            ...
            return binding != null && binding.getKind() == IBinding.VARIABLE && ((IVariableBinding)binding).isField() &&
                   (binding.getModifiers() & (
                           ...
                           Modifier.FINAL | Modifier.STATIC)) == (Modifier.FINAL | Modifier.STATIC);
        }
    }
...
//		}
        ...
        public boolean consumes(SemanticToken token) {
            ...
            if (nodeType != ASTNode.SIMPLE_TYPE && nodeType != ASTNode.THIS_EXPRESSION && nodeType != ASTNode.QUALIFIED_TYPE &&
                nodeType != ASTNode.QUALIFIED_NAME && nodeType != ASTNode.TYPE_DECLARATION && nodeType != ASTNode.METHOD_INVOCATION)
                return false;
...
//		}
        ...
        public boolean consumes(SemanticToken token) {
            ...
            if (nodeType != ASTNode.SIMPLE_TYPE && nodeType != ASTNode.QUALIFIED_TYPE && nodeType != ASTNode.QUALIFIED_NAME &&
                ...
                && nodeType != ASTNode.MARKER_ANNOTATION && nodeType != ASTNode.NORMAL_ANNOTATION && nodeType != ASTNode
