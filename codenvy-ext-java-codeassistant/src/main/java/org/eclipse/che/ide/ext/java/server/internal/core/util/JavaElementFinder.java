...
import org.eclipse.che.ide.ext.java.server.internal.core.BinaryType;
...
public class JavaElementFinder extends BindingKeyParser {
	...
	public void consumeAnnotation() {
		...
		if (size == 0) return;
		IJavaElement annotationType = ((org.eclipse.jdt.internal.core.util.JavaElementFinder)this.types.get(size - 1)).element;
