 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.java.server.internal.core.search.indexing;

import org.eclipse.che.ide.ext.java.server.internal.core.search.processing.JobManager;
...
public class SourceIndexerRequestor implements ISourceElementRequestor, IIndexConstants {
    ...
    /**
     * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#acceptAnnotationTypeReference(char[][], int, int)
     */
    ...
    /**
     * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#acceptAnnotationTypeReference(char[], int)
     */
...
/**
 * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#acceptImport(int, int, int, int, char[][], boolean, int)
 */
...
/**
 * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#acceptPackage(org.eclipse.jdt.internal.compiler.ast.ImportReference)
 */
public void acceptPackage(ImportReference importReference) {
	this.packageName = CharOperation.concatWith(importReference.getImportName(), '.');
}
/**
 * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#acceptProblem(org.eclipse.jdt.core.compiler.CategorizedProblem)
 */
...
private void enterClass(TypeInfo typeInfo) {
	...
	if (typeInfo.typeParameters != null) {
		...
		for (int i = 0; i < typeParametersLength; i++) {
			...
			typeParameterSignatures[i] = Signature.createTypeParameterSignature(typeParameterInfo.name, typeParameterInfo.bounds == null
...
/**
 * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#enterConstructor(org.eclipse.jdt.internal.compiler.ISourceElementRequestor.MethodInfo)
 */
...
/**
 * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#enterField(org.eclipse.jdt.internal.compiler.ISourceElementRequestor.FieldInfo)
 */
...
/**
 * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#enterMethod(org.eclipse.jdt.internal.compiler.ISourceElementRequestor.MethodInfo)
 */
...
/**
 * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#enterType(org.eclipse.jdt.internal.compiler.ISourceElementRequestor.TypeInfo)
 */
...
/**
 * @see org.eclipse.jdt.internal.compiler.ISourceElementRequestor#exitMethod(int, org.eclipse.jdt.internal.compiler.ast.Expression)
 */
