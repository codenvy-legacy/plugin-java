 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.java.server.core.launching;
...
public final class LibraryLocation {
	 ...
	 * @param sourcePath
	 *         The location of the zip file containing the sources for <code>library</code>
	 *         Must not be <code>null</code> (Use Path.EMPTY instead)
	 * @param packageRoot
	 *         The path inside the <code>source</code> zip file where packages names
	 ...
	 *         The location of the javadoc for <code>library</code>
	 * @param indexLocation
	 *         The location of the index for <code>library</code>
	 * @throws IllegalArgumentException
	 *         If the library path is <code>null</code>.
	 * @since 3.7
	 */
	 ...
	 *
	 * @return a {@link java.net.URL} pointing to the Javadoc location associated with
	 ...
	 *
	 * @return a {@link java.net.URL} pointing to the index location associated with
	 * this Library location, or <code>null</code> if none
	 * @since 3.7
	 */
