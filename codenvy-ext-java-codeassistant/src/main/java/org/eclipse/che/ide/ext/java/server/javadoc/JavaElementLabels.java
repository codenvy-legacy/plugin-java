...
public class JavaElementLabels {
    ...
    /**
     * Specifies to use the resolved information of a IType, IMethod or IField. See {@link org.eclipse.jdt.core.IType#isResolved()}.
     ...
     */
    public final static long ALL_FULLY_QUALIFIED = new Long(
     ...
     */
    public final static long ALL_POST_QUALIFIED = new Long(
            F_POST_QUALIFIED | M_POST_QUALIFIED | I_POST_QUALIFIED | T_POST_QUALIFIED | TP_POST_QUALIFIED | D_POST_QUALIFIED |
            CF_POST_QUALIFIED | CU_POST_QUALIFIED | P_POST_QUALIFIED | ROOT_POST_QUALIFIED).longValue();
    /**
     ...
     */
    public final static long DEFAULT_QUALIFIED = new Long(
            F_FULLY_QUALIFIED | M_FULLY_QUALIFIED | I_FULLY_QUALIFIED | T_FULLY_QUALIFIED | D_QUALIFIED | CF_QUALIFIED | CU_QUALIFIED)
            .longValue();
    /**
