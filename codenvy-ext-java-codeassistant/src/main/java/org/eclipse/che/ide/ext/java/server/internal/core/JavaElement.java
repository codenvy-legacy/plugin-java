...
//		}
    ...
    public JavaModelException newNotPresentException() {
        return new org.eclipse.che.ide.ext.java.server.core.JavaModelException(newDoesNotExistStatus());
    }

    protected IJavaModelStatus newDoesNotExistStatus() {
        return new org.eclipse.che.ide.ext.java.server.internal.core.JavaModelStatus(IJavaModelStatusConstants.ELEMENT_DOES_NOT_EXIST, this);
    }
