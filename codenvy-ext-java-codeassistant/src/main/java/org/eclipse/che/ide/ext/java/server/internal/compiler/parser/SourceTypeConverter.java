 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.java.server.internal.compiler.parser;
...
import org.eclipse.che.ide.ext.java.server.internal.core.CompilationUnitElementInfo;
import org.eclipse.che.ide.ext.java.server.internal.core.ImportDeclaration;
import org.eclipse.che.ide.ext.java.server.internal.core.InitializerElementInfo;
import org.eclipse.che.ide.ext.java.server.internal.core.JavaElement;
import org.eclipse.che.ide.ext.java.server.internal.core.PackageFragment;
import org.eclipse.che.ide.ext.java.server.internal.core.SourceAnnotationMethodInfo;
import org.eclipse.che.ide.ext.java.server.internal.core.SourceField;
import org.eclipse.che.ide.ext.java.server.internal.core.SourceFieldElementInfo;
import org.eclipse.che.ide.ext.java.server.internal.core.SourceMethod;
import org.eclipse.che.ide.ext.java.server.internal.core.SourceMethodElementInfo;
...
import org.eclipse.che.ide.ext.java.server.internal.core.util.Util;
...
//		long start = System.currentTimeMillis();
		SourceTypeConverter converter =
				new SourceTypeConverter(flags, problemReporter);
		try {
...
*/
	...
	private QualifiedAllocationExpression convert(IJavaElement localType, FieldDeclaration enumConstant, CompilationResult compilationResult) throws
																																			  JavaModelException {
	 ...
	 */
	private AbstractMethodDeclaration convert(SourceMethod methodHandle, SourceMethodElementInfo methodInfo, CompilationResult compilationResult) throws
																																				  JavaModelException {
		...
		if (methodInfo.isConstructor()) {
			...
			if (methodInfo.isAnnotationMethod()) {
				...
				if ((this.flags & FIELD_INITIALIZATION) != 0) {
					if (hasDefaultValue) {
						char[] defaultValueSource = CharOperation
								.subarray(getSource(), annotationMethodInfo.defaultValueStart, annotationMethodInfo.defaultValueEnd + 1);
