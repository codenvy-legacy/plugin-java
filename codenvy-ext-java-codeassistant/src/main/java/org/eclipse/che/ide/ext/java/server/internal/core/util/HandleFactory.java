 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.java.server.internal.core.util;

import org.eclipse.che.ide.ext.java.server.core.search.IJavaSearchScope;
import org.eclipse.che.ide.ext.java.server.internal.core.search.AbstractJavaSearchScope;
...
//        this.javaModel = JavaModelManager.getJavaModelManager().getJavaModel();
	 ...
	 */
	public IJavaElement createLambdaTypeElement(LambdaExpression expression, ICompilationUnit unit, HashSet existingElements,
												HashMap knownScopes) {
...
//			JavaProject javaProject = (JavaProject) this.javaModel.getJavaProject((File)target);
//			try {
//				IClasspathEntry entry = javaProject.getClasspathEntryFor(jarPath);
//				if (entry != null) {
//					return (PackageFragmentRoot) javaProject.getPackageFragmentRoot(jarPath.toOSString());
//				}
...
//					if (target instanceof File) {
//						// internal jar
//						return (PackageFragmentRoot) javaProject.getPackageFragmentRoot((File)target);
//					} else {
//						// external jar
...
//					if (root.internalPath().isPrefixOf(path) && !Util
//                            .isExcluded(path, root.fullInclusionPatternChars(), root.fullExclusionPatternChars(), false)) {
//						return root;
//					}
//				}
