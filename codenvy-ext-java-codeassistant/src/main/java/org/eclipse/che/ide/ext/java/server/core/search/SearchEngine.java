...
import org.eclipse.che.ide.ext.java.server.internal.core.search.IRestrictedAccessTypeRequestor;
import org.eclipse.che.ide.ext.java.server.internal.core.search.TypeNameMatchRequestorWrapper;
import org.eclipse.che.ide.ext.java.server.internal.core.search.TypeNameRequestorWrapper;
...
//		}
	 ...
	 * @exception org.eclipse.core.runtime.CoreException if the search failed. Reasons include:
	 *	<ul>
	 *		<li>the classpath is incorrectly set</li>
	 *	</ul>
	 *@since 3.0
	 */
	public void search(SearchPattern pattern, SearchParticipant[] participants, IJavaSearchScope scope, SearchRequestor requestor, IProgressMonitor monitor) throws
                                                                                                                                                                                         CoreException {
	 ...
	 * 					{@link #searchAllTypeNames(char[], int, char[], int, int, IJavaSearchScope, TypeNameRequestor, int, org.eclipse.core.runtime.IProgressMonitor)}
	 ...
	 *	</ul>
	 * @since 3.1
	 * @deprecated Use {@link #searchAllTypeNames(char[], int, char[], int, int, IJavaSearchScope, TypeNameRequestor, int, org.eclipse.core.runtime.IProgressMonitor)}
	 * 	instead
	 */
	 ...
	 *	</ul>
	 * @since 3.0
	 *@deprecated Use {@link #searchAllTypeNames(char[], char[], int, int, IJavaSearchScope, TypeNameRequestor, int, org.eclipse.core.runtime.IProgressMonitor)} instead
	 */
	public void searchAllTypeNames(
		final char[] packageName,
		final char[] typeName,
	 ...
	 *		<li>the classpath is incorrectly set</li>
	 *	</ul>
	 *@deprecated Use {@link #searchAllTypeNames(char[], char[], int, int, IJavaSearchScope, ITypeNameRequestor, int, org.eclipse.core.runtime.IProgressMonitor)} instead
	 */
	public void searchAllTypeNames(
