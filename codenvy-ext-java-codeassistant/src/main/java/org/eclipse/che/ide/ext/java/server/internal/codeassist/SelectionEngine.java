 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.java.server.internal.codeassist;
...
import org.eclipse.che.ide.ext.java.server.core.search.TypeNameMatchRequestor;
import org.eclipse.che.ide.ext.java.server.internal.codeassist.impl.Engine;
import org.eclipse.che.ide.ext.java.server.internal.compiler.parser.SourceTypeConverter;
import org.eclipse.che.ide.ext.java.server.internal.core.BinaryTypeConverter;
import org.eclipse.che.ide.ext.java.server.internal.core.ClassFile;
...
import org.eclipse.che.ide.ext.java.server.internal.core.SourceType;
...
import org.eclipse.che.ide.ext.java.server.internal.core.search.TypeNameMatchRequestorWrapper;
import org.eclipse.che.ide.ext.java.server.internal.core.search.indexing.IndexManager;
import org.eclipse.che.ide.ext.java.server.internal.core.util.ASTNodeFinder;
...
public final class SelectionEngine extends Engine implements ISearchRequestor {
				...
				new ProblemReporter(
					...
					public CategorizedProblem createProblem(
						...
						CategorizedProblem pb = super.createProblem(
								...
								lineNumber,
								columnNumber);
						if (SelectionEngine.this.problem == null && pb.isError() &&
				...
				switch (kind) {
					...
					case ClassFileConstants.AccAnnotation | ClassFileConstants.AccInterface:
						...
						if (length == this.acceptedAnnotationsCount) {
							...
							System.arraycopy(this.acceptedAnnotationsModifiers, 0, this.acceptedAnnotationsModifiers = new int[newLength],
											 0, length);
						}
					...
					case ClassFileConstants.AccInterface:
						...
						if (length == this.acceptedInterfacesCount) {
							...
							System.arraycopy(this.acceptedInterfacesModifiers, 0, this.acceptedInterfacesModifiers = new int[newLength], 0,
											 length);
						}
					...
					default:
						...
						if (length == this.acceptedClassesCount) {
							...
							System.arraycopy(this.acceptedClassesModifiers, 0, this.acceptedClassesModifiers = new int[newLength], 0,
											 length);
						}
				...
				if (imports != null) {
					for (int i = 0, length = imports.length; i < length; i++) {
						...
						if (importReference instanceof SelectionOnImportReference) {
							...
							this.noProposal = false;
							this.requestor.acceptPackage(CharOperation.concatWith(tokens, '.'));
							this.nameEnvironment.findTypes(CharOperation.concatWith(tokens, '.'), false, false, IJavaSearchConstants.TYPE,
														   this);
	...
	public void selectType(char[] typeName, IType context) throws JavaModelException {
		try {
			...
			if (cu != null) {
				...
				CompilationResult result = new CompilationResult((org.eclipse.jdt.internal.compiler.env.ICompilationUnit) cu, 1, 1, this
				...
				ClassFileReader reader = (ClassFileReader) classFile.getBinaryTypeInfo((IFile) null/*classFile.resource()*/, false/*don't fully initialize so as to keep constant pool (used below)*/);
	...
	protected MethodBinding findOverriddenMethodInType(ReferenceBinding overriddenType, MethodBinding overriding) throws
																												  JavaModelException {
	...
	static abstract class InheritDocVisitor {
		 ...
		 *         {@link #visitInheritDoc(org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding)}</li>
		 *         </ul>
		 * @throws org.eclipse.jdt.core.JavaModelException unexpected problem
		 * @see #visitInheritDoc(org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding)
		 */
		 ...
		 * @return the result from a call to {@link #visit(org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding)}, or <code>null</code> if none of
