...
public class StandardVMType implements IVMInstallType {
	 ...
	 * <b>Note:</b> Must be at least -Xmx16m for JRockit, see <a href="https://bugs.eclipse.org/bugs/show_bug.cgi?id=433455">bug
	 * 433455</a>.
	 *
	 * @since 3.7.100
	 */
...
//	private static ILibraryLocationResolver[] fgLibraryLocationResolvers = null;
	 ...
	 *         the {@link java.io.File} location to look in
...
//								}
								LibraryLocation library =
										new LibraryLocation(libPath, sourcePath, packageRoot, javadocLocation, indexLocation);
