 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.java.server.corext.util;
 ...
 * <p>
 * {@link org.eclipse.jdt.core.IMember#getFlags()} (and hence {@link org.eclipse.jdt.core.Flags}) only take explicitly declared flags
...
public class JdtFlags {
	 ...
	 *
	 * @param visibility1 First visibility value to compare. Valid inputs are the {@link org.eclipse.jdt.core.dom.Modifier} visibility constants.
	 * @param visibility2 Second visibility value to compare. Valid inputs are the {@link org.eclipse.jdt.core.dom.Modifier} visibility constants.
