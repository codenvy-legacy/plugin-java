...
/**
 * Tree structure for Gradle project. It also respects multi-module projects.
 *
...
public class GradleProjectTreeStructure extends JavaTreeStructure {
    ...
    /**
     * Creates a new {@link GradleModuleNode} owned by this tree
     * with the specified {@code parent} and associated {@code data}.
     *
     * @param parent
     *         the parent node
     ...
     */
    public GradleModuleNode newModuleNode(@Nonnull AbstractTreeNode parent, @Nonnull ProjectDescriptor data) {
