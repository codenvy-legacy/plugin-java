...
/**
 * {@link GradleFolderNode} that may contains source files.
 *
 * @author Vladyslav Zhukovskii
 * @see com.codenvy.ide.ext.java.client.projecttree.nodes.JavaFolderNode
 */
public class GradleFolderNode extends JavaFolderNode {
            ...
            public void onSuccess(final Array<ProjectDescriptor> modules) {
                getChildren(getData().getPath(), new AsyncCallback<Array<ItemReference>>() {
                    ...
                    public void onFailure(Throwable e) {
                        Log.error(GradleFolderNode.class, e);
    ...
    /** Get child node from current Folder node. */
