...
@Singleton
public class GradleTestSourceFolderValueProviderFactory implements ValueProviderFactory {
    @Override
    public String getName() {
        return GradleAttributes.TEST_SOURCE_FOLDER;
    }
    ...
    public ValueProvider newInstance(final Project project) {
        return new ValueProvider() {
            ...
            public List<String> getValues() throws ValueStorageException {
                return GradleUtils.getSourceDirectories(project, GradleUtils.SRC_DIR_TYPE.TEST);
            }
