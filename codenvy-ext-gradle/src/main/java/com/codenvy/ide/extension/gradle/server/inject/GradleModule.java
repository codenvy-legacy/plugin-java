...
import com.codenvy.ide.extension.gradle.server.GradleSourceFolderValueProviderFactory;
import com.codenvy.ide.extension.gradle.server.GradleTestSourceFolderValueProviderFactory;
...
public class GradleModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        multiBinder.addBinding().to(GradleTestSourceFolderValueProviderFactory.class);
