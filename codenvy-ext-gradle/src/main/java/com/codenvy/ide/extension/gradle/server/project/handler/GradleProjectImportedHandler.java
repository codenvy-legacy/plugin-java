...
@Singleton
public class GradleProjectImportedHandler implements PostImportProjectHandler {

    private GradleProjectResolver projectResolver;

    @Inject
    public GradleProjectImportedHandler(GradleProjectResolver projectResolver) {
