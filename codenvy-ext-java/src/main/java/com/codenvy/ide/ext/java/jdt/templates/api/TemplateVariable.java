 ...
 * <code>TemplateVariableResolver</code>s can be used to resolve a template variable to a symbol available from the
 * <code>TemplateContext</code>. A resolved variable may have one or more possible {@link #getValues() values} which may be
 * presented to the user as choices. If there is no user interaction the {@link #getDefaultValue() default value} is chosen as
 * textual representation of the variable.
 * <p>
...
public class TemplateVariable {
     ...
     * @param values
     *         the values available at this variable, non-empty
     * @param offsets
     *         the array of offsets of the variable
     */
    ...
    /**
     * Returns the default value of the variable. Typically, this is the first of the possible values (see {@link #getValues()}.
     *
    ...
    /**
     * Returns the possible values for this variable. The returned array is owned by this variable and must not be modified. The
     * array is not empty.
     *
    ...
    /**
     * Returns the initial length of the variable. The initial length is the lenght as it occurred in the template pattern and is
     * used when resolving a template to update the pattern with the resolved values of the variable.
     *
    ...
    /**
     * Resolves the variable to a single value. This is a shortcut for <code>setValues(new String[] { value })</code>.
     *
     * @param value
