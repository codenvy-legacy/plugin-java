...
public class UnusedCodeCleanUp extends AbstractMultiFix {
    ...
    private boolean requireAST() {
        ...
        return removeUnuseMembers && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_METHODS) || removeUnuseMembers
                                                                                                       && isEnabled(
                CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_CONSTRUCTORS) || removeUnuseMembers
                                                                             &&
    ...
    protected ICleanUpFix createFix(CompilationUnit compilationUnit, Document document) throws CoreException {
        ...
        return UnusedCodeFix.createCleanUp(compilationUnit, removeUnuseMembers
                                           ...
                                           && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_CONSTRUCTORS), removeUnuseMembers
                                                                                                                   && isEnabled(
                CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_FELDS), removeUnuseMembers
                                                                    && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_TYPES),
                                           isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_LOCAL_VARIABLES),
    ...
    protected ICleanUpFix createFix(CompilationUnit compilationUnit, Document document, IProblemLocation[] problems)
        ...
        return UnusedCodeFix.createCleanUp(compilationUnit, problems, removeMembers
                                           ...
                                           && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_CONSTRUCTORS), removeMembers
                                                                                                                   && isEnabled(
                CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_FELDS), removeMembers
                                                                    && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_TYPES),
                                           isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_LOCAL_VARIABLES),
                                           isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_IMPORTS) &&
                                           !isEnabled(CleanUpConstants.ORGANIZE_IMPORTS),
    ...
    public String[] getStepDescriptions() {
        ...
        if (isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_IMPORTS))
            result.add(MultiFixMessages.INSTANCE.UnusedCodeMultiFix_RemoveUnusedImport_description());
        if (isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_MEMBERS)
            && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_METHODS))
            result.add(MultiFixMessages.INSTANCE.UnusedCodeMultiFix_RemoveUnusedMethod_description());
        if (isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_MEMBERS)
            && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_CONSTRUCTORS))
            result.add(MultiFixMessages.INSTANCE.UnusedCodeMultiFix_RemoveUnusedConstructor_description());
        if (isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_MEMBERS)
            && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_TYPES))
            result.add(MultiFixMessages.INSTANCE.UnusedCodeMultiFix_RemoveUnusedType_description());
        if (isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_MEMBERS)
            && isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_PRIVATE_FELDS))
            result.add(MultiFixMessages.INSTANCE.UnusedCodeMultiFix_RemoveUnusedField_description());
        if (isEnabled(CleanUpConstants.REMOVE_UNUSED_CODE_LOCAL_VARIABLES))
            result.add(MultiFixMessages.INSTANCE.UnusedCodeMultiFix_RemoveUnusedVariable_description());
