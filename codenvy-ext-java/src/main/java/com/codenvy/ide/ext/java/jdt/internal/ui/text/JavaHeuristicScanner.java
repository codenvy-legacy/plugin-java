...
public final class JavaHeuristicScanner implements Symbols {
     ...
     * @since 3.2
     */
    private TypedRegion fCachedPartition = new TypedRegionImpl(-1, 0, "__no_partition_at_all"); //$NON-NLS-1$
     ...
     *         the partition to scan in
     */
    public JavaHeuristicScanner(Document document, String partitioning, String partition) {
     ...
     *         the document to scan.
     */
    public JavaHeuristicScanner(Document document) {
        this(document, JavaPartitions.JAVA_PARTITIONING, Document.DEFAULT_CONTENT_TYPE);
    }
     ...
     */
    public Region findSurroundingBlock(int offset) {
        ...
        if (begin == NOT_FOUND || end == NOT_FOUND)
            return null;
        return new RegionImpl(begin, end + 1 - begin);
    }
     ...
     * @param bound
     *         the first position in <code>fDocument</code> to not consider any more, with <code>bound</code> &gt; <code>position</code>,
     *         or
     *         <code>UNBOUND</code>
     * @return the smallest position of a non-whitespace character in [<code>position</code>, <code>bound</code>) that resides in a Java
     ...
     *         or
     *         <code>UNBOUND</code>
     * @return the highest position of a non-whitespace character in (<code>bound</code>, <code>position</code>] that resides in a Java
     *         partition, or <code>NOT_FOUND</code> if none can be found
     */
     ...
     * @return the lowest position of <code>ch</code> in (<code>bound</code>, <code>position</code>] that resides in a Java partition, or
     ...
     * @return the lowest position of a non-whitespace character in [<code>position</code>, <code>bound</code>) that resides in a Java
     *         partition, or <code>NOT_FOUND</code> if none can be found
     */
    ...
    /**
     * Finds the highest position <code>p</code> in <code>fDocument</code> such that <code>bound</code> &lt; <code>p</code> &lt;=
     * <code>start</code>
     ...
     * @param condition
     *         the <code>StopCondition</code> to check
     * @return the highest position in (<code>bound</code>, <code>start</code> for which <code>condition</code> holds, or
     *         <code>NOT_FOUND</code> if none can be found
     */
     ...
     * @return <code>true</code> if <code>position</code> is in the default partition of <code>fDocument</code>,
     ...
     */
    private TypedRegion getPartition(int position) {
        if (!contains(fCachedPartition, position)) {
            ...
            try {
                ...
                fCachedPartition = new TypedRegionImpl(position, 0, "__no_partition_at_all"); //$NON-NLS-1$
            }
        }
     ...
     * @since 3.2
     */
    private boolean contains(Region region, int position) {
     ...
     *
     * @param start
     *         the position where the type name of the class instance creation supposedly ends
     * @param bound
     *         the first position in <code>fDocument</code> to not consider any more, with
     *         <code>bound</code> &lt; <code>start</code>, or <code>UNBOUND</code>
    ...
    private static class NonWhitespace extends StopCondition {
        ...
        public boolean stop(char ch, int position, boolean forward) {
            return !CharOperation.isWhitespace(ch);
        }
    }
    ...
    private final class NonWhitespaceDefaultPartition extends NonWhitespace {
        ...
        @Override
        public int nextPosition(int position, boolean forward) {
            TypedRegion partition = getPartition(position);
