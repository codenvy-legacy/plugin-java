...
public final class CharOperation {
     ...
     *         the second given array
     * @param start
     *         the starting position to compare (inclusive)
     * @param end
     *         the ending position to compare (exclusive)
     * @return the returned value of the comparison between array1 and array2
     * @throws NullPointerException
     *         if one of the arrays is null
     * @since 3.7.1
     ...
     * @param array
     *         the array that is concatenated with the prefix and suffix characters
     * @param suffix
     *         the suffix character
     * @return the new array
     */
     ...
     *
     * @param array
     *         the array within which the int value is to be parsed
     * @param start
     *         first character of the int value in array
     * @param length
     *         length of the int value in array
     * @return the int value of a subpart of array
     * @throws NumberFormatException
     *         if the designated subpart of array does not parse to an int
     * @since 3.4
     */
     ...
     *         the replacement character
     * @param start
     *         the given start position (inclusive)
     * @param end
