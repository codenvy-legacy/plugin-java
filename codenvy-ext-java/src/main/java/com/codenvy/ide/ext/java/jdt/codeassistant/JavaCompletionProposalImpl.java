...
public class JavaCompletionProposalImpl extends AbstractJavaCompletionProposal {
    ...
    // * @param displayString the string to be displayed for the proposal If set to <code>null</code>, the replacement string will
    // be taken as display string.
    // * @param relevance the relevance
    // */
    // public JavaCompletionProposal(String replacementString, int replacementOffset, int replacementLength, Image image, String
    ...
    // * @param relevance the relevance
    // */
    // public JavaCompletionProposal(String replacementString, int replacementOffset, int replacementLength, Image image,
     ...
     * @param displayString
     *         the string to be displayed for the proposal If set to <code>null</code>, the replacement string will be
     ...
     */
    public JavaCompletionProposalImpl(String replacementString, int replacementOffset, int replacementLength, Images image,
     ...
     *         the invocation context of this completion proposal or <code>null</code> not available
     */
    public JavaCompletionProposalImpl(String replacementString, int replacementOffset, int replacementLength, Images image,
                                      StyledString displayString, int relevance, boolean inJavadoc,
