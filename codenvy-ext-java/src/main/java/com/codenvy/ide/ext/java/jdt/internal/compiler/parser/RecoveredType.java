       ...
       */
        ...
        if (this.memberTypes == null) {
            ...
            if (this.memberTypeCount == this.memberTypes.length) {
                System.arraycopy(this.memberTypes, 0, (this.memberTypes = new RecoveredType[2 * this.memberTypeCount]), 0,
    ...
    public RecoveredElement addAnnotationName(int identifierPtr, int identifierLengthPtr, int annotationStart,
        ...
        if (this.pendingAnnotations == null) {
            ...
            if (this.pendingAnnotationCount == this.pendingAnnotations.length) {
                System.arraycopy(this.pendingAnnotations, 0, (this.pendingAnnotations =
                        new RecoveredAnnotation[2 * this.pendingAnnotationCount]), 0, this.pendingAnnotationCount);
            }
        }
            ...
            if (this.typeDeclaration.superclass == null) {
                if (this.typeDeclaration.typeParameters == null) {
                    ...
                    return this.typeDeclaration.bodyStart ==
                           this.typeDeclaration.typeParameters[this.typeDeclaration.typeParameters.length - 1].sourceEnd + 1;
                }
            } else {
      ...
      /* update member types */
        if (this.memberTypeCount > 0) {
            ...
            if (updatedCount < this.memberTypeCount) {
                ...
                System
                        .arraycopy(memberTypeDeclarations, 0, memberTypeDeclarations = new TypeDeclaration[length], 0, length);
            }
         ...
         /* might want to recover implemented interfaces */
            ...
            if (parser.listLength > 0 && parser.astLengthPtr > 0) { // awaiting interface type references
                ...
                if (canConsume) {
                    ...
                    System.arraycopy(parser.genericsStack, genericsPtr - length + 1, typeDecl.typeParameters =
