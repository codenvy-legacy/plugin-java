 ...
 *******************************************************************************/
package com.codenvy.ide.ext.java.jdt.text.edits;
...
import com.codenvy.ide.ext.java.jdt.text.BadPartitioningException;
import com.codenvy.ide.ext.java.jdt.text.Document;
import com.codenvy.ide.ext.java.jdt.text.DocumentListener;
import com.codenvy.ide.ext.java.jdt.text.DocumentPartitioner;
import com.codenvy.ide.ext.java.jdt.text.DocumentPartitioningListener;
...
class EditDocument implements Document {
    ...
    /** @see com.codenvy.ide.ext.java.jdt.text.Document#getPartitionings() */
    @Override
    public String[] getPartitionings() {
        throw new UnsupportedOperationException();
    }

    /** @see com.codenvy.ide.ext.java.jdt.text.Document#getLegalContentTypes(java.lang.String) */
    @Override
    public String[] getLegalContentTypes(String partitioning) throws BadPartitioningException {
        throw new UnsupportedOperationException();
    }

    /** @see com.codenvy.ide.ext.java.jdt.text.Document#getContentType(java.lang.String, int, boolean) */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.jdt.text.Document#getPartition(java.lang.String, int, boolean) */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.jdt.text.Document#computePartitioning(java.lang.String, int, int, boolean) */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.jdt.text.Document#setDocumentPartitioner(java.lang.String, com.codenvy.ide.ext.java.jdt.text.DocumentPartitioner) */
    @Override
    public void setDocumentPartitioner(String partitioning, DocumentPartitioner partitioner) {
        throw new UnsupportedOperationException();
    }

    /** @see com.codenvy.ide.ext.java.jdt.text.Document#getDocumentPartitioner(java.lang.String) */
    @Override
    public DocumentPartitioner getDocumentPartitioner(String partitioning) {
        throw new UnsupportedOperationException();
    }

    /** @see com.codenvy.ide.ext.java.jdt.text.Document#getModificationStamp() */
    @Override
    public long getModificationStamp() {
        throw new UnsupportedOperationException();
    }

    /** @see com.codenvy.ide.ext.java.jdt.text.Document#replace(int, int, java.lang.String, long) */
    @Override
