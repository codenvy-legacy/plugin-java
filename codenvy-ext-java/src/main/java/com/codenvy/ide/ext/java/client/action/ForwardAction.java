...
public class ForwardAction extends Action {
    ...
    @Inject
    public ForwardAction(JavaResources resources, JavaLocalizationConstant constant, QuickDocumentation quickDocumentation) {
        super(constant.actionQuickdocForward(), constant.actionQuickdocForward(), null, resources.rightArrow());
        this.quickDocumentation = quickDocumentation;
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        quickDocumentation.forward();
    }
}
