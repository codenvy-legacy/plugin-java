...
import com.codenvy.ide.ext.java.jdt.internal.codeassist.select.SelectionJavadocParser;
import com.codenvy.ide.ext.java.jdt.internal.codeassist.select.SelectionNodeFound;
import com.codenvy.ide.ext.java.jdt.internal.codeassist.select.SelectionOnImportReference;
import com.codenvy.ide.ext.java.jdt.internal.codeassist.select.SelectionOnPackageReference;
import com.codenvy.ide.ext.java.jdt.internal.codeassist.select.SelectionParser;
			...
			if(!isValuesOrValueOf && !methodBinding.isSynthetic()) {
				...
				if (isLocal(declaringClass) && this.requestor instanceof SelectionRequestor) {
					...
					this.requestor.acceptMethod(
						...
						this.actualSelectionStart,
						this.actualSelectionEnd,
                        parsedUnit.declarationOfType(new char[][]{methodBinding.declaringClass.sourceName}));
				}
			}
			this.acceptedAnswer = true;
...
//	}
		...
		for (int i = 0, length = methods == null ? 0 : methods.length; i < length; i++){
			...
			if (method.selector == assistIdentifier){
				...
				this.requestor.acceptMethod(
					...
					this.actualSelectionStart,
					this.actualSelectionEnd, enclosingType);
	...
	private Object findMethodWithAttachedDocInHierarchy(final MethodBinding method) {
		...
		return new InheritDocVisitor() {
			public Object visit(ReferenceBinding currType){
...
//				}
	...
	static abstract class InheritDocVisitor {
		 ...
		 */
		public abstract Object visit(ReferenceBinding currType);
		 ...
		 * @throws JavaModelException unexpected problem
		 */
		public Object visitInheritDoc(ReferenceBinding currentType){
