...
package com.codenvy.ide.ext.java.patchers;

import com.codenvy.ide.ext.java.jdt.internal.compiler.parser.RSC;
...
public class ParserResources {
    ...
    public static String[] readableNames(RSC rsc) {
        InputStream inputStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("com/codenvy/ide/ext/java/patchers/readableNames");
        Gson gson = new Gson();
    ...
    private static long[] readFileLongs(String fileName) {
        InputStream inputStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("com/codenvy/ide/ext/java/patchers/" + fileName);
        Gson gson = new Gson();
        InputStreamReader reader = new InputStreamReader(inputStream);
